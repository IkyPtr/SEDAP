...
import { notesAPI } from "../../src/services/noteApi";
import { AiFillDelete } from "react-icons/ai"; // Import icon yang hilang
...
export default function Notes() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      loadNotes(); // Uncomment ini untuk refresh data
    } catch (err) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      await notesAPI.deleteNote(id); // Pastikan API ini ada
